 ...
 * @params[in] xcr_ring reference to XHCI command ring structure
 * @return
 *  0 on successful command ring initialisation
 *  errno  on failure
 */
 ...
 * @param[in] req_byte_align alignment of the trb
